...
# while True:
#     mon_yr = driver.find_element(By.XPATH, "//div[@id='month-year-label']").text.strip()
#     parts = mon_yr.split()
#     mon = parts[0]
#     yr = int(parts[1])
...
#     )
#     print("\nYour Booking process is successful and confirmed.")
# except Exception as e:
#     print(f"\nAn error occurred while redirecting to booking complete page.")
#
# time.sleep(5)
# # driver.close()
